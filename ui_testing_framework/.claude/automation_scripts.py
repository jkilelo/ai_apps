...
class ClaudeCodeAutomation:
    ...
    def __init__(self):
        # Updated for ui_testing_automation specific project
        self.project_root = Path(__file__).parent.parent  # ui_testing_automation directory
        self.claude_dir = self.project_root / '.claude'
        self.settings_path = self.claude_dir / 'settings.json'
        self.templates_path = self.claude_dir / 'prompt_templates.json'
        
        # Add ui_testing_automation to Python path for imports
