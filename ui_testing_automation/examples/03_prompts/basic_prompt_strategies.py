...
def example_2_task_type_optimization():
    ...
    for task_type, scenario in task_scenarios.items():
        ...
        try:
            ...
            match_symbol = "[OK]" if expected_match else "!"
    ...
    for task_type, result in successful_optimizations.items():
        ...
        if result["expected_match"]:
            print(f"    [OK] Selection aligned with expectations")
        else:
    ...
    for strategy in benchmark_strategies:
        ...
        for test in performance_tests:
            ...
            try:
                ...
                print(f"        [OK] Success: {execution_time:.2f}s, confidence: {response.confidence:.2f}")
...
def main():
    ...
    print("  [OK] 21 research-backed prompt strategies")
    print("  [OK] Dynamic strategy selection and optimization")
    print("  [OK] Performance tracking and metrics")
    print("  [OK] Reusable template management")
    print("  [OK] Task type classification and optimization")
    print("  [OK] Strategy effectiveness analysis")
