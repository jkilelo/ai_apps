...
# No need for LLMProvider enum - using default LLM from llm.py
...
# Simplified LLM wrapper using llm.py
class SimpleLLMWrapper:
    """Simple wrapper for LLM calls using llm.py"""
...
# Removed OpenAIProvider - using llm.py

# Removed AnthropicProvider - using llm.py

# Removed GeminiProvider - using llm.py
