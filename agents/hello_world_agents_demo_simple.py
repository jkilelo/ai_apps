...
def google_adk_hello_world():
    ...
    print("[SUCCESS] Google ADK works natively with your Vertex setup!")
...
def langchain_hello_world():
    ...
    print("=" * 70)
    print(f"Response time: {elapsed_time:.2f} seconds")
    print("[SUCCESS] LangChain works with custom LLM wrapper!")
...
def openai_agents_hello_world():
    ...
    print("=" * 70)
    print(f"Response time: {elapsed_time:.2f} seconds")
    print("[SUCCESS] OpenAI SDK style works with Vertex adapter!")
...
def pydantic_ai_hello_world():
    ...
    print("=" * 70)
    print(f"Response time: {elapsed_time:.2f} seconds")
    print("[SUCCESS] Pydantic AI style works with custom model!")
...
def main():
    ...
    print("   [OK] Direct client call works!\n")
    ...
    print("-" * 40)
    print("[OK] Google ADK: Native support (fastest, no wrapper needed)")
    print("[OK] LangChain: Works with custom LLM wrapper")
    print("[OK] OpenAI SDK: Works with adapter pattern")
    print("[OK] Pydantic AI: Works with custom Model class")
