    ...
    for provider in available_providers:
        ...
        for test in benchmark_tests:
            ...
            try:
                ...
                print(f"        ✓ {response_time:.2f}s, {response.tokens_used} tokens")
    ...
    for scenario in cost_test_scenarios:
        ...
        for provider in available_providers:
            ...
            try:
                ...
                print(f"        ✓ Cost/token: ${total_cost / response.tokens_used:.6f}" if response.tokens_used > 0 else "")
...
def example_3_advanced_retry_and_failover():
    ...
    for test in resilience_tests:
        ...
        for provider in available_providers:
            ...
            try:
                ...
                print(f"        ✓ Unexpected success: {response.content[:50]}")
                ...
                print(f"        ✗ Time to failure: {total_time:.2f}s")
    ...
    if len(available_providers) >= 2:
        ...
        try:
            ...
            print(f"        ✓ Primary succeeded unexpectedly")
            
        except Exception as primary_error:
            print(f"        ✗ Primary failed as expected: {type(primary_error).__name__}")
            ...
            try:
                ...
                print(f"        ✓ Backup succeeded: {response.content[:50]}")
                print(f"        ✓ Backup response time: {backup_time:.2f}s")
                print(f"        → Failover mechanism would work effectively")
                
            except Exception as backup_error:
                print(f"        ✗ Backup also failed: {type(backup_error).__name__}")
        ...
        for provider in available_providers:
            ...
            try:
                ...
                if effectiveness_scores:
                    ...
                    print(f"        ✓ Profile effectiveness: {avg_effectiveness:.1f}/10")
...
async def main():
    ...
    print("  ✓ Multi-provider performance benchmarking")
    print("  ✓ Cost optimization and budget analysis")
    print("  ✓ Resilience testing and failover mechanisms")
    print("  ✓ Custom optimization profiles")
