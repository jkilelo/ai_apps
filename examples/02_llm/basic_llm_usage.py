    ...
    for provider_name in available_providers:
        ...
        try:
            ...
            response = query_llm(
                ...
                model="gpt-4" if provider_name == "openai" else "default",
...
def example_3_error_handling_and_retry():
    ...
    try:
        ...
        response = query_llm(
            ...
            model="gpt-4",
            messages=[{"role": "user", "content": "Hello"}],
            timeout=0.001  # Extremely short timeout to trigger retry
        )
...
def main():
    ...
    print("  ✓ Token tracking and cost optimization")
    print("  ✓ Provider comparison and selection")
