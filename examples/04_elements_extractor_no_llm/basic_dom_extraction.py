...
async def example_3_element_classification():
    ...
    try:
        ...
        print(f"✅ High-confidence elements: {len(result.elements)}")
...
async def example_4_performance_monitoring():
    ...
    if successful_results:
        ...
        print(f"  ⏱️  Average extraction time: {avg_extraction_time:.3f}s")
...
async def main():
    ...
    print(f"⚡ No LLM dependencies for maximum speed and reliability")
