...
# Import contracts first (Layer 0)
...
class ElementWithLLMContext(BaseModel):
    ...
    element_data: ElementData = Field(..., description="From browser_contracts.py")
...
class ExtractionWithLLMResult(BaseModel):
    ...
    browser_result: BrowserExtractionResult = Field(..., description="From browser_contracts.py")
