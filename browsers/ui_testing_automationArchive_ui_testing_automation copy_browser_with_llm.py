...
class BrowserWithLLM:
    ...
    async def extract_and_analyze(
        ...
        result = ExtractionWithLLMResult(url=url)
    ...
    async def _generate_page_insights(
        ...
        insights = {
            ...
            'performance_metrics': browser_result.performance_metrics,
            'security_findings': [],
    ...
    def _create_insights_prompt(
        ...
        - Page load time: {browser_result.performance_metrics.get('page_load_time', 'unknown')}
    ...
    async def parallel_extract_and_analyze(
        ...
        for i, result in enumerate(results):
            if isinstance(result, Exception):
                error_result = ExtractionWithLLMResult(url=urls[i])
