...
def example_1_opro_optimization():
    ...
    for iteration in range(opro_iterations):
        ...
        try:
            ...
            if quality_score > best_score:
                ...
                print(f"     ✓ New best score! Improvement: +{improvement:.1f}%")
            else:
    ...
    if successful_iterations:
        ...
        if total_improvement >= research_min_improvement:
            print(f"✓ Exceeds research minimum improvement")
...
def example_2_self_consistency_ensemble():
    ...
    if len(successful_paths) >= 2:
        ...
        for concept, data in consensus_recommendations.items():
            ...
            if data["has_consensus"]:
                if strength >= 0.8:
                    ...
                    print(f"  ✓ {concept_name}: {votes}/{len(successful_paths)} paths (Consensus: {strength:.1%})")
        ...
        if research_improvement_range[0] <= improvement_percentage <= research_improvement_range[1]:
            print(f"✓ Within research improvement range")
...
def example_3_meta_cognitive_framework():
    ...
    for level_info in metacognitive_levels:
        ...
        try:
            ...
            print(f"    ✓ Confidence: {response.confidence:.3f}")
            print(f"    ✓ Meta-cognitive score: {metacognitive_score:.3f}")
            print(f"    ✓ Indicators found: {sum(metacognitive_indicators.values())}/5")
    ...
    if successful_levels:
        ...
        if avg_metacognitive_score >= 0.8:
            ...
            print(f"  ✓ Good meta-cognitive processing achieved")
    ...
    for config in ensemble_configs:
        ...
        for i, strategy in enumerate(config['strategies']):
            ...
            try:
                ...
                print(f"        ✓ {strategy_time:.2f}s, confidence: {response.confidence:.3f}")
...
async def main():
    ...
    print("  ✓ OPRO optimization with iterative improvement")
    print("  ✓ Self-consistency with consensus analysis")
    print("  ✓ Meta-cognitive framework for higher-order reasoning")
    print("  ✓ Ensemble methods with strategy combination")
    print("  ✓ Performance benchmarking against research claims")
    print("  ✓ Real-world complex problem solving")
