...
class SyntheticDataGenerator:
    ...
    def save_to_hive(self, df: pd.DataFrame, database: str, table_name: str):
        """Save DataFrame to Hive table - Fixed version"""
        ...
        # Convert pandas DataFrame to list of dictionaries (more reliable)
        data_dict = df.to_dict('records')
        
        # Create Spark DataFrame from list of dictionaries
        spark_df = self.spark.createDataFrame(data_dict)
    ...
    def generate_customers(self, num_records: int = 10000) -> pd.DataFrame:
        ...
        for i in range(num_records):
            ...
            customer = {
                ...
                'last_updated': str(self.faker.date_time_between(start_date=registration_date, end_date='now'))
            }
    ...
    def generate_products(self, num_records: int = 5000) -> pd.DataFrame:
        ...
        for i in range(num_records):
            ...
            product = {
                ...
                'launch_date': str(self.faker.date_between(start_date='-3y', end_date='today')),
                'last_updated': str(self.faker.date_time_between(start_date='-1y', end_date='now'))
            }
    ...
    def generate_stores(self, num_records: int = 500) -> pd.DataFrame:
        ...
        for i in range(num_records):
            ...
            store = {
                ...
                'opening_date': str(self.faker.date_between(start_date='-10y', end_date='-1d')),
                ...
                'last_renovation': str(self.faker.date_between(start_date='-5y', end_date='today')),
    ...
    def generate_employees(self, num_records: int = 2000) -> pd.DataFrame:
        ...
        for i in range(num_records):
            ...
            employee = {
                ...
                'phone': self.faker.phone_number(),
                'ssn': self.faker.ssn(),
                'date_of_birth': str(self.faker.date_of_birth(minimum_age=22, maximum_age=65)),
                'gender': random.choice(['M', 'F', 'Other']),
                ...
                'termination_date': str(self.faker.date_between(start_date=hire_date, end_date='today')) 
    ...
    def generate_suppliers(self, num_records: int = 1000) -> pd.DataFrame:
        ...
        for i in range(num_records):
            ...
            supplier = {
                ...
                'contract_start': str(self.faker.date_between(start_date='-5y', end_date='-1y')),
                'contract_end': str(self.faker.date_between(start_date='today', end_date='+3y')),
                'is_preferred': random.choice([True, False]),
                'lead_time_days': random.randint(1, 60),
                'minimum_order_value': random.randint(100, 10000),
                'last_order_date': str(self.faker.date_between(start_date='-6m', end_date='today')),
    ...
    def generate_inventory(self, num_records: int = 20000) -> pd.DataFrame:
        ...
        for _ in range(num_records):
            ...
            inv_record = {
                ...
                'last_count_date': str(self.faker.date_between(start_date='-90d', end_date='today')),
                'last_received_date': str(self.faker.date_between(start_date='-60d', end_date='today')),
        ...
        for _ in range(num_records):
            ...
            for event_num in range(num_events):
                behavior = {
                    ...
                    'customer_id': customer_id,
                    'event_timestamp': str(current_time),
    ...
    def generate_reviews(self, num_records: int = 15000) -> pd.DataFrame:
        ...
        for i in range(num_records):
            ...
            review = {
                ...
                'review_date': str(self.faker.date_between(start_date='-2y', end_date='today')),
